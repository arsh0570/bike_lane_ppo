...
from snman import street_graph, graph, io, merge_edges, lane_graph  # removed 'distribution'
...
def generate_motorized_lane_graph(
    ...
    # REPLACEMENT: manually copy lane descriptions to KEY_GIVEN_LANES_DESCRIPTION
    given_lanes_dict = nx.get_edge_attributes(G, target_lanes_attribute)
    nx.set_edge_attributes(G, given_lanes_dict, KEY_GIVEN_LANES_DESCRIPTION)
